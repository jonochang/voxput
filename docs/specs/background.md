<Right>Here’s a clean background brief for Voxput.
...
Specifically, Voxput should:
	...
	•	Display a GNOME top-bar indicator showing:
	    •	Idle
	    •	Recording
	    •	Transcribing
	    •	Error
	...
	•	Insert the resulting text at the current cursor location (or optionally copy to clipboard)
...
Platform Constraints
	...
	•	Input injection may require compositor-compatible tools (e.g., wtype) or clipboard fallback.
...
If you’d like, I can also write:
	...
	•	A short product positioning summary
	•	Or a technical architecture overview suitable for a GitHub README or RFC document
